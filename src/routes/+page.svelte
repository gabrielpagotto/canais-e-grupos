...
<div class="w-full flex ns-responsive-grid">
  {#each data.chats as chat (chat.id)}
    <a href="/conversas/{chat.id}">
      <div
        class="m-2 rounded bg-white border border-slate-200 hover:border-teal-400 hover:cursor-pointer transition-colors flex flex-col items-center overflow-hidden"
      >
